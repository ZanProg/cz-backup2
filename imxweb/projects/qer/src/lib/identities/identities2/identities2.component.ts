...
import { CollectionLoadParameters, DataModel, DataModelProperty, DisplayColumns, EntitySchema, IClientProperty, CompareOperator, FilterData, FilterType } from 'imx-qbm-dbts';
import {
...
@Component({
  selector: 'imx-data-explorer-identities2',
  templateUrl: './identities2.component.html',
  styleUrls: ['./identities2.component.scss'],
})
export class Identities2Component implements OnInit, OnDestroy, SideNavigationComponent {
