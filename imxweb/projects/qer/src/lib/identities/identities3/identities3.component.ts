...
@Component({
  selector: 'imx-data-explorer-identities3',
  templateUrl: './identities3.component.html',
  styleUrls: ['./identities3.component.scss'],
})
export class Identities3Component implements OnInit, OnDestroy, SideNavigationComponent {
