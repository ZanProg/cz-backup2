...
@Component({
  selector: 'imx-create-new-identity3',
  templateUrl: './create-new-identity3.component.html',
  styleUrls: ['./create-new-identity3.component.scss']
})
export class CreateNewIdentity3Component implements OnDestroy {
