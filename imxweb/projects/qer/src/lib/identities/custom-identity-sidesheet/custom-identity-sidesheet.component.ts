...
// import { FeatureConfig, QerProjectConfig, PortalPersonReports, PortalAdminPerson, RequestableProductForPerson, PortalPersonMasterdata, PortalCandidatesPersonindepartment } from 'imx-api-qer';
...
@Component({
  selector: 'ccc-custom-identity-sidesheet',
  templateUrl: './custom-identity-sidesheet.component.html',
  styleUrls: ['./custom-identity-sidesheet.component.scss']
})
export class CustomIdentitySidesheetComponent implements OnInit, OnDestroy{
  ...
  //     canEdit: boolean;
  //     isInCorrectGroup: PortalPersonMasterdata;
  //     department: PortalCandidatesPersonindepartment;
  //   },
  ...
  //   this.subscriptions.push(authentication.onSessionResponse.subscribe((sessionState) => (console.log(sessionState, data.isInCorrectGroup))));
  ...
  //  // this.cdrListPersonal = this.cdrFactoryService.buildCdrFromColumnListAdvanced(this.data.selectedIdentity.GetEntity(), customColumns, readOnlyColumns)
