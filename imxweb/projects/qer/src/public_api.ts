...
export { CreateNewIdentity2Component } from './lib/identities/create-new-identity2/create-new-identity2.component'
export { CreateNewIdentity3Component } from './lib/identities/create-new-identity3/create-new-identity3.component'
export { CreateExternalComponent } from './lib/identities/create-external/create-external.component'
export { CreateRobotComponent } from './lib/identities/create-robot/create-robot.component'
export { Identities2Component } from './lib/identities/identities2/identities2.component'
